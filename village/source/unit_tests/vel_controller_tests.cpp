...
TEST_CASE("initialised vel_controller outputs zero acc and vel", "[vel_controller_flying]")
{
...
TEST_CASE("right button outputs expected vel", "[vel_controller_flying]")
{
  vel_controller_flying vc;
...
TEST_CASE("max_speed scales velocity vec length", "[vel_controller_flying]")
{
  vel_controller_flying vc;
...
TEST_CASE("left button outputs expected vel", "[vel_controller_flying]")
{
  vel_controller_flying vc;
...
TEST_CASE("left and right button outputs expected vel", "[vel_controller_flying]")
{
  vel_controller_flying vc;
  vc.on_dir_button_action(dir_button_action(dir_button_name::left, button_value::down));
  vc.on_dir_button_action(dir_button_action(dir_button_name::right, button_value::down));
